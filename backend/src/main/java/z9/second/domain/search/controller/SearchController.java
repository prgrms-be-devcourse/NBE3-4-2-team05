package z9.second.domain.search.controller;
...
import z9.second.domain.search.service.SearchService;
...
public class SearchController {
    ...
    public BaseResponse<List<SearchResponseDto>> searchClasses(
        ...
        return BaseResponse.ok(SuccessCode.CLASS_READ_SUCCESS, response);
    }
