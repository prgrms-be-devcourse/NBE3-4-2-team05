...
public enum ErrorCode {
    ...
    CLASS_READ_FAILED(HttpStatus.BAD_REQUEST, Boolean.FALSE, 3009, "해당하는 모임을 조회할 수 없습니다."),
    CLASS_MASTER_TRANSFER_ME(HttpStatus.BAD_REQUEST, Boolean.FALSE, 3009, "본인에게 권한을 위임할 수 없습니다."),
