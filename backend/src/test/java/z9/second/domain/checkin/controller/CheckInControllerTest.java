...
class CheckInControllerTest extends SpringBootTestSupporter {
    ...
    void createCheckIn() throws Exception {
        ...
        result.andDo(print())
                ...
                .andExpect(jsonPath("$.isSuccess").value(SuccessCode.CHECK_IN_CREATE_SUCCESS.getIsSuccess()))
    ...
    void updateCheckIn() throws Exception {
        ...
        result.andDo(print())
                ...
                .andExpect(jsonPath("$.isSuccess").value(SuccessCode.CHECK_IN_UPDATE_SUCCESS.getIsSuccess()))
    ...
    void getAllCheckInsForSchedule() throws Exception {
        ...
        result.andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.isSuccess").value(SuccessCode.CHECK_IN_READ_SUCCESS.getIsSuccess()))
