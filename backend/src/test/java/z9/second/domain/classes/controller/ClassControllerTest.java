...
import z9.second.domain.classes.base.ClassBaseTest;
...
public class ClassControllerTest extends ClassBaseTest {
    ...
    void createClass() throws Exception {
        ...
        result.andDo(print())
                ...
                .andExpect(jsonPath("$.isSuccess").value(SuccessCode.CLASS_CREATE_SUCCESS.getIsSuccess()))
    ...
    void createClass_limitExceeded() throws Exception {
        ...
        result.andDo(print())
                ...
                .andExpect(jsonPath("$.isSuccess").value(ErrorCode.CLASS_CREATE_LIMIT_EXCEEDED.getIsSuccess()))
    ...
    void joinClass() throws Exception {
        ...
        result.andDo(print())
                ...
                .andExpect(jsonPath("$.isSuccess").value(SuccessCode.CLASS_JOIN_SUCCESS.getIsSuccess()))
    ...
    void resignClass() throws Exception {
        ...
        result.andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.isSuccess").value(SuccessCode.CLASS_RESIGN_SUCCESS.getIsSuccess()))
    ...
    void entryClass() throws Exception {
        ...
        result.andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.isSuccess").value(SuccessCode.SUCCESS.getIsSuccess()))
    ...
    void modifyClass() throws Exception {
        ...
        result.andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.isSuccess").value(SuccessCode.CLASS_MODIFY_SUCCESS.getIsSuccess()))
    ...
    void deleteClass() throws Exception {
        ...
        result.andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.isSuccess").value(SuccessCode.CLASS_DELETE_SUCCESS.getIsSuccess()))
    ...
    void transferMaster() throws Exception {
        ...
        result.andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.isSuccess").value(SuccessCode.CLASS_MASTER_TRANSFER_SUCCESS.getIsSuccess()))
